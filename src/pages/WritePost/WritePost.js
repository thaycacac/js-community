...
class WritePost extends Component {
  ...
  addPost() {
    ...
    this.state.title && text
      ...
      : alert("You miss something (title or content)!");
  }
      ...
      <div>
        ...
        <div className="writing-container">
          <div className="writing-navigation">
            ...
            >
              <i className="fa fa-paper-plane-o" /> Post
            </button>
          </div>
          ...
          <div className="writing-title">
            <form>
              ...
              <input
                ...
                type="text"
                placeholder="hashtag : web,android,..."
                onChange={event => {
          ...
          <div className="writing-hint">
            <code>ctrl B</code> - <strong>bold</strong>
            <br />
            <code>ctrl I</code> - <i>italy</i>
            <br />
            <code>ctrl U</code> - <u>underline</u>
            <br />
            <code>ctrl `</code> - <code>code</code>
            <br />
            <i>- You must select the text before editing link</i>
            <br />
            <i>- You can drag and drop images to the editor</i>
            <br />
          </div>
        </div>
      </div>
