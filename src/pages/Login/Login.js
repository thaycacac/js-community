            ...
            <div className="main-body">
                <div className="intro-header">
                    <div className="intro-js">
                        <img src={logoJSNon} alt="logo JS white" style={{width:'50px', margin: '3px'}}/>JS Community                      
                    </div>
                    <Facebook/>
                </div>
                <div className="main-content">
                    ...
                    <img src={logojs} width="40%" className="img-left" alt="Logo JS"/>
                    ...
                    <img src={houseJS} width="60%" className="img-right" alt="JS Family"/>
                    <p>
